...
print("Loading parameters and initializing variables...".ljust(80), end='', flush=True)
...
all_data['clock_offset'] = compute_clock_offset(all_data['time'], dt0, dt1, dt2)
...
coord_ITRF = compute_ITRF_satellite_position(GMe, a, e, M0, Omega0, OmegaEdot, Omegadot, i0, idot, w0, wdot, all_data['time'])
